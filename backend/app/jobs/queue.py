...
TASK_NAMES = {
    ...
    JobType.SQS: "jobs.sqs",
    JobType.NEB: "jobs.neb",
    JobType.ADSORPTION: "jobs.adsorption",
}
...
def _run_inline(job_type: JobType, job_id: str) -> None:
    ...
    target = {
        ...
        JobType.SQS: runners.run_sqs_job,
        JobType.NEB: runners.run_neb_job,
        JobType.ADSORPTION: runners.run_adsorption_job,
    }[job_type]
