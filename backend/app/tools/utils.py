...
def visualize_structure(poscar_path, save_path):
    ...
    <div id='title' class='overlay'>
        Materia Structure Viewer (Powered by 3Dmol.js)
    </div>
...
def list_files_in_dir(dir):
    ...
    base_dir = os.environ.get('MATERIA_SESSION_RUNS_DIR')
    all_files = []
...
def start_new_session():
    ...
    base_dir = os.getcwd()
    main_dir = os.path.join(base_dir, 'materia_projects')
...
#SBATCH --job-name=materia_job
#SBATCH --output=materia_job.out
#SBATCH --error=materia_job.err
...
# This script was generated by Materia to update VASP input files and submit jobs.
...
def load_system_prompts():
    # src/materia/ai_mode/system_prompt.txt
...
║  ╚═╝     ╚═╝ ╚═╝  ╚═╝ ╚══════╝  ╚═════╝  ╚══════╝ ╚═╝  ╚═══╝    ╚═╝     ║
║                                                                         ║
║                                   Materia: Materials Simulation Agent   ║
...
║  Repository:    https://github.com/aguang5241/Materia                   ║
...
def clear_and_print_entry_message():
    ...
    msg = f'''
Welcome to Materia — Your Materials Simulations Agent.
---------------------------------------------------------
Current Session Runs Directory: {os.environ["MATERIA_SESSION_RUNS_DIR"]}
...
def clear_and_print_banner_and_entry_message():
    ...
    print_banner()
    msg = f'''
Welcome to Materia — Your Materials Simulation Agent.
---------------------------------------------------------
Current Session Runs Directory: {os.environ["MATERIA_SESSION_RUNS_DIR"]}
...
def print_help():
    ...
    content = '''
Materia - Available Commands and Functions: 
-------------------------------------------
