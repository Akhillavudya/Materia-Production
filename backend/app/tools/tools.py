...
def generate_vasp_poscar(formula: str) -> dict:
    ...
    try:
        ...
        comments_0 = f'# (Most Stable) Generated by Materia from Materials Project entry {mid_0}, crystal system: {docs[0].symmetry.crystal_system}, space group: {docs[0].symmetry.symbol}.'
        ...
        for doc in docs:
            ...
            comments = f'# Generated by Materia from Materials Project entry {mid}, crystal system: {crystal_system}, space group: {space_group_symbol}.'
...
@with_metadata(schemas.ToolMetadata(
    ...
    defaults={
        'poscar_path': f'{os.environ.get("MATERIA_SESSION_RUNS_DIR")}/POSCAR',
        'only_incar': False,
        },
    prereqs=[],
))
def generate_vasp_inputs_from_poscar(
    vasp_input_sets: str,
    poscar_path: str = f'{os.environ.get("MATERIA_SESSION_RUNS_DIR")}/POSCAR',
    ...
    try:
        ...
        if only_incar:
            ...
            incar_comments = f'# Generated by Materia using {vasp_input_sets} set provided by Materials Project.'
        ...
        incar_comments = f'# Generated by Materia using {vasp_input_sets} set provided by Materials Project.'
        write_comments(os.path.join(vasp_inputs_dir, 'INCAR'), 'incar', incar_comments)
        poscar_comments = f'# Generated by Materia using {vasp_input_sets} set provided by Materials Project.'
        write_comments(os.path.join(vasp_inputs_dir, 'POSCAR'), 'poscar', poscar_comments)
        kpoints_comments = f'# Generated by Materia using {vasp_input_sets} set provided by Materials Project.'
...
# This Slurm script was generated by Materia, customize as needed.
{command}
'''
        script_path = os.path.join(runs_dir, 'materia_submit.sh')
...
@with_metadata(schemas.ToolMetadata(
    ...
    defaults={'poscar_path': f'{os.environ.get("MATERIA_SESSION_RUNS_DIR")}/POSCAR'},
    prereqs=[],
))
def convert_poscar_coordinates(
    ...
    try:
        ...
        comments = f'# Generated by Materia converted to {coord_type} coordinates.'
...
@with_metadata(schemas.ToolMetadata(
    ...
    defaults={'poscar_path': f'{os.environ.get("MATERIA_SESSION_RUNS_DIR")}/POSCAR', 'custom_kppa': None, 'gamma_centered': True},
    prereqs=[],
))
def customize_vasp_kpoints_with_accuracy(
    ...
    try:
        ...
        comments = f'# Generated by Materia with {accuracy_level} accuracy (Grid Density = {kppa} / number of atoms)'
...
def generate_vasp_poscar_with_vacancy_defects(
    ...
    try:
        ...
        comments = f'# Generated by Materia with vacancy defects of element {original_element} by randomly removing {num_defects} atoms, be careful to verify structure.'
...
def generate_vasp_poscar_with_substitution_defects(
    ...
    try:
        ...
        write(os.path.join(defect_dir, 'POSCAR'), atoms, format='vasp', direct=True, sort=True)
        comments = f'# Generated by Materia with substitution defect of element {original_element} to {defect_element} by randomly substituting {num_defects} atoms, be careful to verify structure.'
        write_comments(os.path.join(defect_dir, 'POSCAR'), 'poscar', comments)
    ...
    try:
        ...
        if len(defect_structures) == 0:
            ...
            for i, defect_structure in enumerate(defect_structures):
                ...
                comments = f'# Generated by Materia with interstitial (Voronoi) defect of element {defect_element} at fract. coords {defect_sites[i]}, be careful to verify structure.'
...
def generate_supercell_from_poscar(
    ...
    try:
        ...
        comments = f'# Generated by Materia as supercell with scaling matrix {scaling_matrix}.'
...
def generate_sqs_from_poscar(
    ...
    try:
        ...
        set_log_config(
        filename=f'{sqs_dir}/materia_sqs.log',
        level='INFO',
        )
        ...
        comments = f'# Generated by Materia as Special Quasirandom Structure (SQS) with target configurations {target_configurations} using icet.'
...
def generate_surface_slab_from_poscar(
    ...
    try:
        ...
        comments = f'# Generated by Materia as surface slab with Miller indices {miller_indices}, vacuum thickness {vacuum_thickness} Å, and slab layers {slab_layers}.'
...
def generate_interface_from_poscars(
    ...
    try:
        ...
        from app.tools.utils.interface_maker import run_interface_maker
        run_interface_maker(
...
def generate_vasp_workflow_of_convergence_tests(
    ...
    def test_kpoints():
        ...
        incar_comments = f'# Generated by Materia for k-point convergence test.'
        ...
        for kppa in kpoint_levels:
            ...
            poscar_comments = f'# Generated by Materia for k-point convergence test with kppa = {kppa}.'
            ...
            kpoint_comments = f'# Generated by Materia for k-point convergence test with kppa = {kppa}.'
    ...
    def test_encut():
        ...
        kpoint_comments = f'# Generated by Materia for energy cutoff convergence test.'
        ...
        for encut in encut_levels:
            ...
            incar_comments = f'# Generated by Materia for energy cutoff convergence test with ENCUT = {encut}.'
            write_comments(os.path.join(test_dir, 'INCAR'), 'incar', incar_comments)
            vis.poscar.write_file(os.path.join(test_dir, 'POSCAR'))
            poscar_comments = f'# Generated by Materia for energy cutoff convergence test with ENCUT = {encut}.'
            write_comments(os.path.join(test_dir, 'POSCAR'), 'poscar', poscar_comments)
...
def generate_vasp_workflow_of_eos(
    ...
    try:
        ...
        incar_comments = f'# Generated by Materia for EOS calculation'
        write_comments(os.path.join(eos_dir, 'INCAR_temp'), 'incar', incar_comments)
        kpoint_comments = f'# Generated by Materia for EOS calculation'
        ...
        for scale in scale_factors:
            ...
            poscar_comments = f'# Generated by Materia for EOS calculation with scale factor = {scale:.3f}.'
...
def generate_vasp_workflow_of_elastic_constants(
    ...
    try:
        ...
        incar_comments = f'# Generated by Materia for elastic constants calculation.'
        write_comments(os.path.join(elastic_dir, 'INCAR_temp'), 'incar', incar_comments)
        kpoint_comments = f'# Generated by Materia for elastic constants calculation.'
        ...
        for D_dict in D_all:
            ...
            poscar_comments = f'# Generated by Materia for elastic constants calculation with deformation {folder_name}.'
...
def generate_vasp_workflow_of_aimd(
    ...
    try:
        ...
        kpoint_comments = f'# Generated by Materia for AIMD simulation.'
        ...
        for temperature in temperatures:
            ...
            incar_comments = f'# Generated by Materia for AIMD simulation at {temperature} K for {md_steps} steps with timestep {md_timestep} fs.'
            write_comments(os.path.join(temp_dir, 'INCAR'), 'incar', incar_comments)
            vis.poscar.write_file(os.path.join(temp_dir, 'POSCAR'))
            poscar_comments = f'# Generated by Materia for AIMD simulation at {temperature} K for {md_steps} steps with timestep {md_timestep} fs.'
...
def generate_vasp_workflow_of_neb(
    ...
    try:
        ...
        incar_comments = f'# Generated by Materia for NEB calculation with {num_images} images.'
        write_comments(os.path.join(neb_dir, 'INCAR'), 'incar', incar_comments)
        kpoint_comments = f'# Generated by Materia for NEB calculation with {num_images} images.'
        ...
        for i, image in enumerate(images):
            ...
            poscar_comments = f'# Generated by Materia for NEB calculation image {i}.'
...
def analyze_vasp_workflow_of_convergence_tests(
    ...
    try:
        ...
        if encut_tests_dict:
            ...
            ax.set_title('Materia ENCUT Convergence Test')
        ...
        if kpoint_tests_dict:
            ...
            ax.set_ylabel('Energy Difference (meV/atom)')
            ax.set_title('Materia Kpoint Convergence Test')
...
def analyze_vasp_workflow_of_eos(
    ...
    try:
        ...
        poscar_comments = f'# Generated by Materia for EOS calculation with scale factor = {equilibrium_scale:.6f}, equilibrium volume = {equilibrium_volume:.6f} Å³/atom.'
...
def analyze_vasp_workflow_of_elastic_constants(
    ...
    try:
        ...
        with open(f'{runs_dir}/elastic_constants.txt', 'w') as f:
            f.write(f'# Elastic constants and moduli calculated by Materia\n')
...
def analyze_vasp_workflow_of_aimd(
    ...
    try: 
        ...
        for root, dirs, files in os.walk(runs_dir):
            for dir_name in dirs:
                if dir_name.startswith('T_') and dir_name.endswith('K'):
                    ...
                    ax[0].set_title(f'Materia AIMD Temperature & Energy at {temperature} K')
                    ...
                    ax.set_title(f'Materia AIMD Mean Squared Displacement at {temperature} K')
        ...
        with open(f'{runs_dir}/aimd_activation_energy.txt', 'w') as f:
            f.write(f'# Materia AIMD Analysis\n\n')
        ...
        ax.set_title('Materia AIMD Arrhenius Plot of Diffusion Coefficient')
        ax.legend(frameon=True, loc='upper right')
...
def analyze_vasp_workflow_of_neb(
    ...
    try:
        ...
        ax.set_title('Materia NEB Analysis')
...
def run_simulation_using_mlps(
    ...
    def fit_and_plot_eos(scales, structures, volumes, energies, mlps_type, task_dir):
        ...
        poscar_comments = f'# Generated by Materia for EOS calculation with scale factor = {equilibrium_scale:.6f}.'
        ...
        ax.set_ylabel('Energy (eV/atom)')
        ax.set_title(f'Materia EOS using {mlps_type}')
        ax.legend(frameon=True, loc='upper right')
    ...
    def parse_and_plot_md_log(logfile, mlps_type, task_dir):
        ...
        ax[0].set_title(f'Materia MD using {mlps_type}')
    ...
    try:
        ...
        if task_type == 'single':
            ...
            atoms = read(poscar_path, format='vasp')
            atoms.calc = calc
            # opt = LBFGS(FrechetCellFilter(atoms), logfile=f'{task_dir}/materia_mlps_single.log')
            opt = LBFGS(atoms, logfile=f'{task_dir}/materia_mlps_single.log')
            opt.run(fmax=fmax, steps=max_steps)
            atoms.write(f'{task_dir}/CONTCAR', format='vasp', direct=True, sort=True)
            comments = f'# Generated by Materia from simulation using {mlps_type} with fmax = {fmax} eV/Å.'
            ...
            return {
                ...
                'simulation_log_path': f'{task_dir}/materia_mlps_single.log',
            ...
            for scale in scale_factors:
                ...
                comments = f'# Generated by Materia for EOS calculation with scale factor = {scale:.3f} using {mlps_type}.'
                ...
                atoms.calc = calc
                # opt = LBFGS(FrechetCellFilter(atoms), logfile=f'{task_dir}/materia_mlps_eos_{scale:.3f}.log')
                opt = LBFGS(atoms, logfile=f'{task_dir}/materia_mlps_eos_{scale:.3f}.log')
                opt.run(fmax=fmax, steps=max_steps)
            ...
            for D_dict in D_all:
                ...
                comments = f'# Generated by Materia for elastic constants calculation with deformation {folder_name} using {mlps_type}.'
                ...
                atoms.calc = calc
                # opt = LBFGS(FrechetCellFilter(atoms), logfile=f'{task_dir}/materia_mlps_elastic_{folder_name}.log')
                opt = LBFGS(atoms, logfile=f'{task_dir}/materia_mlps_elastic_{folder_name}.log')
                opt.run(fmax=fmax, steps=max_steps)
            ...
            with open(f'{task_dir}/elastic_constants.txt', 'w') as f:
                f.write(f'# Elastic constants and moduli calculated using {mlps_type} by Materia\n')
                f.write(f'\nElastic Constants (GPa):\n')
                for row in elastic_constants:
                    f.write('\t'.join([f'{val:.2f}' for val in row]) + '\n')
                f.write('\nMechanical Properties (GPa):')
            ...
            dyn = NoseHooverChainNVT(
                ...
                trajectory=f'{task_dir}/materia_mlps_md.traj',
                loginterval=10,
            ...
            dyn.attach(MDLogger(
                dyn=dyn,
                atoms=atoms,
                logfile=f'{task_dir}/materia_mlps_md.log',
                header=True,
                peratom=True,
                mode='w',
            ), interval=10)
            dyn.run(md_steps)
            parse_and_plot_md_log(f'{task_dir}/materia_mlps_md.log', mlps_type, task_dir)
            return {
                'status': 'success',
                'message': f'Completed MD simulation using {mlps_type} in {mlps_simulation_dir}.',
                'mlps_simulation_dir': mlps_simulation_dir,
                'md_trajectory_path': f'{task_dir}/materia_mlps_md.traj',
                'md_log_path': f'{task_dir}/materia_mlps_md.log',
...
def analyze_features_for_machine_learning(
    ...
    try:
        ...
        ax.set_title('Materia Feature Correlation Matrix')
...
def augment_data_for_machine_learning(
    ...
    try:
        ...
        from app.tools.utils.ml_cvae import run_cvae_augmentation
...
def design_model_for_machine_learning(
    ...
    try:
        ...
        from app.tools.utils.ml_nn_design import optimize
...
def train_model_for_machine_learning(
    ...
    try:
        ...
        # Run model training
        from app.tools.utils.ml_nn_train import train
...
def model_prediction_for_AlMgSiSc(
    ...
    try:
        ...
        with open(os.path.join(ml_model_prediction_dir, 'AlMgSiSc_prediction.txt'), 'w') as f:
            f.write(f'# Mechanical properties prediction for Al-Mg-Si-Sc alloy using pre-trained machine learning model by Materia\n')
            f.write(f'\nInput Compositions:\n')
...
def model_prediction_for_AlCoCrFeNi(
    ...
    try:
        ...
        with open(os.path.join(ml_model_prediction_dir, 'AlCoCrFeNi_prediction.txt'), 'w') as f:
            f.write(f'# Phase stability & elastic properties prediction for Al-Co-Cr-Fe-Ni high-entropy alloy using pre-trained machine learning model by Materia\n')
            f.write(f'\nInput Compositions:\n')
